...
// Export the configuration object when running in Node.js.  In the
// Google Apps Script environment the `module` object is undefined, so
// this block will be ignored.  Exporting the config allows unit tests
// and offline scripts to access the CONFIG values via require().
